...
j = User.create(username: "james", password: "abc123", manageable_fund: 1000)
y = User.create(username: "yamada", password: "abc123", manageable_fund: 3000)
h = User.create(username: "hana", password: "abc123", manageable_fund: 500)

#505 Stocks
stocks.each do |stock|
    Stock.create(Name: stock[:Name], Symbol: stock[:Symbol], Sector: stock[:Sector])
end


#4 portfolios
a = PortfolioList.create(user: j, stock: Stock.first, price: 20, volume: 100, pending: true)
b = PortfolioList.create(user: y, stock: Stock.second, price: 100, volume: 40, pending: true)
c = PortfolioList.create(user: h, stock: Stock.third, price: 25, volume: 200, pending: true)
d = PortfolioList.create(user: j, stock: Stock.second, price: 0.3, volume: 10000, pending: true)
